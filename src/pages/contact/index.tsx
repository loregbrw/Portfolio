        ...
        <>
            <section id="contact">
                <StyledFooter>
                    ...
                    <StyledButtons>
                        <StyledButton onClick={() => window.open("mailto:loregobara@gmail.com", '_blank')} width={40} bgColor={EColorPalette.INDIANRED}>{language === "Portuguese" ? "Mandare-mail" : "Send email"}</StyledButton>
